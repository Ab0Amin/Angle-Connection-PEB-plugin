...
namespace Angle_Connection_plugin
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double Connection_shift = double.Parse(tx_connectionShift.Text);
            //stiffner
            ...
            double boltEdge2_x_1 = double.Parse(tx_boltedge2_x_1.Text);
            double boltEdge2_x_2 = double.Parse(tx_boltedge2_x_1.Text);
            ...
            double bolt_shift_1 = double.Parse(tx_bolt_shift_1.Text);
            ...
            Part secendaryPart = new Picker().PickObject(Picker.PickObjectEnum.PICK_ONE_PART) as Part;
            ...
            if (mainSolid.Intersect(centerLineSecandryPart).Count == 0)
            {
                #region case beam c profie
                {
                    ...
                    //bolts points 
                    //t3d.Point pointBolt_1 = new t3d.Point(platePoint1.X + platePoint1.Y, platePoint1.Z + bolt_shift_1);
                    //t3d.Point pointBolt_2 = new t3d.Point(plateMidPoint.X + plateMidPoint.Y, plateMidPoint.Z + bolt_shift_1);


                    //t3d.Point pointBolt_3 = new t3d.Point(platePoint3.X + platePoint3.Y, platePoint3.Z + bolt_shift_2);
                    //t3d.Point pointBolt_4 = new t3d.Point(plateMidPoint.X + plateMidPoint.Y, plateMidPoint.Z + bolt_shift_2);
